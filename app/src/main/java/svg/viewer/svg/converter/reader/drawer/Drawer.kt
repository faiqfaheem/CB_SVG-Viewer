...
open class Drawer : DrawerLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyle: Int) {
        val a = context.obtainStyledAttributes(attrs, R.styleable.drawerLayout)
        cardBackgroundColor = a.getColor(R.styleable.drawerLayout_cardBackgroundColor, 0)
        a.recycle()
        ...
        addDrawerListener(object : DrawerListener {
            override fun onDrawerSlide(drawerView: View, slideOffset: Float) {
                this@Drawer.drawerView = drawerView
...
//                    || window.decorView.layoutDirection == View.LAYOUT_DIRECTION_RTL || resources.configuration.layoutDirection == View.LAYOUT_DIRECTION_RTL
    ...
    companion object {
        private val TAG = Drawer::class.java.simpleName
    }
}